...
=======
  filter(Measurement == "T2" | Measurement  == "T3" | Measurement == "T6" | Measurement == "T7")#%>%
>>>>>>> d0d90d494331e881448c8817077ab972e5041a72
...
pam_mod_full2 <- gamlss(Fv_Fm_av ~ Treatment + Measurement + Treatment*Measurement + random(Anemone_ID), data = pam_short_timeseries, family = GB1(), method = mixed(50,100), control = gamlss.control(n.cyc = 200))
=======
...
pam_mod_full2 <- gamlss(Fv_Fm_av ~ Treatment + Measurement + Treatment*Measurement + random(Anemone_ID), data = pam_short_timeseries, family = GB1(), control = gamlss.control(n.cyc = 200))
