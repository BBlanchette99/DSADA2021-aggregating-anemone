...
#Plot of overall trend (Acclimation, beginning/end of heatwave, end of recovery)
p1_data <- pam_summary%>%
...
ggsave(path = "plots",filename = "pam_timeseries.png", width = 10, height = 7)
...
#Weakly flat priors
bay_mod <- brm(Open_Closed ~ Treatment + Time_Block + Treatment*Time_Block + (1|Anemone_ID), data = open_closed_clean, family = cumulative("logit"))
```
