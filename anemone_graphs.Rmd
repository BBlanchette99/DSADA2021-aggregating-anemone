...
hemo_clean <- hemocytometer %>%
  mutate(Tentacle_Mass_mg = (Tentacle_Mass_g*1000), Dino_Density = ((Number_Dino_Average*0.5)/(Tentacle_Mass_mg*0.0001)), Green_Density = ((Number_Green_Average*0.5)/(Tentacle_Mass_mg*0.0001)), Dividing_Dino_Density = ((Dividing_Dino_Average*0.5)/(Tentacle_Mass_mg*0.0001)), Dividing_Green_Density = ((Dividing_Green_Average*0.5)/(Tentacle_Mass_mg*0.0001))) %>%
  mutate(Date = as.factor(Date), Treatment = as.factor(Treatment), Bin = as.factor(Bin), Anemone_ID = as.factor(Anemone_ID)) %>%
  select(Date, Treatment, Bin, Anemone_ID, Tentacle_Mass_mg, Number_Dino_Average, Number_Green_Average, Dividing_Dino_Average, Dividing_Green_Average, Dino_Density, Green_Density, Dividing_Dino_Density, Dividing_Green_Density) %>%
  group_by(Date, Treatment)
