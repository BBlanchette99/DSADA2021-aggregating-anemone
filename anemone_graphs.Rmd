...
food_clean <- food%>%
  ...
  mutate(Feeding_Time_Min = as.numeric(Feeding_Time_Min),Date = as.factor(Date), Site = as.factor(Site), Treatment = as.factor(Treatment), Anemone_ID = as.factor(Anemone_ID), Bin = as.factor(Bin), log_Feeding_Time_Min = log(Feeding_Time_Min))%>%
select(Date, Treatment, Bin, Site, Anemone_ID, Feeding_Time_Min, log_Feeding_Time_Min)
